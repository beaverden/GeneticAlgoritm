...
static double SixHump(ChromossomePtr ch, void* globalContext)
{
...
static double SixHumpEval(const ChromossomePtr& ch, void* globalContext)
{
...
std::pair<double, double> TestSixHump(
	...
	std::ofstream* file)
{
	GlobalContext context = { -2, 2, N, PRECISION };
